        ...
        Thread hilo = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Player player;
                    try{
                        fis = new FileInputStream(ruta + "/src/Sonido/saltar.mp3");
            ...
            Thread hilo = new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        Player player;
                        try{
                            fis = new FileInputStream(ruta + "/src/Sonido/caida.mp3");
                        }catch (FileNotFoundException e){
            ...
            Thread hilo = new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        Player player;
                        try{
                            fis = new FileInputStream(ruta + "/src/Sonido/choque.mp3");
                        }catch(FileNotFoundException e){
        ...
        Thread hilo = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Player player;
                    try{
                        fis = new FileInputStream(ruta + "/src/Sonido/puntos.mp3");
                    } catch(FileNotFoundException e){
